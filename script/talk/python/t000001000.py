...
# Innards Flags Setup
def t000001000_x80():
    assert t000001000_x81(30000, 75010) # Innards of Vitality
    assert t000001000_x81(30010, 75020) # Innards of Wisdom
    assert t000001000_x81(30020, 75030) # Innards of Tenacity
    assert t000001000_x81(30030, 75040) # Innards of Fortitude
    assert t000001000_x81(30040, 75050) # Innards of Reflection
    assert t000001000_x82(30050, 75060) # Innards of Regeneration
    assert t000001000_x82(30060, 75070) # Innards of Tranquility
    assert t000001000_x81(30070, 75080) # Innards of Endurance
    assert t000001000_x81(30080, 75090) # Innards of Greed
    assert t000001000_x81(30090, 75100) # Innards of Finesse
    assert t000001000_x81(30100, 75110) # Innards of Courage
    assert t000001000_x81(30110, 75120) # Innards of Clarity
    
    return 0

# Update Innard Flags - Stack 5
def t000001000_x81(item=_, flag=_):
    SetEventFlag(flag, 0)
...
def t000001000_x82(item=_, flag=_):
    SetEventFlag(flag, 0)
    SetEventFlag(flag + 1, 0)
    SetEventFlag(flag + 2, 0)
...
def t000001000_x111():
    ...
    while True:
        ...
        # Vitality
        if GetTalkListEntryResult() == 1:
            assert t000001000_x120()
            continue
        # Wisdom
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x121()
            continue
        # Tenacity
        elif GetTalkListEntryResult() == 3:
            assert t000001000_x122()
            return 0
        # Fortitude
        elif GetTalkListEntryResult() == 4:
            assert t000001000_x123()
            return 0
        # Reflection
        elif GetTalkListEntryResult() == 5:
            assert t000001000_x124()
            return 0
        # Regeneration
        elif GetTalkListEntryResult() == 6:
            assert t000001000_x125()
            return 0
        # Tranquility
        elif GetTalkListEntryResult() == 7:
            assert t000001000_x126()
            return 0
        # Endurance
        elif GetTalkListEntryResult() == 8:
            assert t000001000_x127()
            return 0
        # Greed
        elif GetTalkListEntryResult() == 9:
            assert t000001000_x128()
            return 0
        # Finesse
        elif GetTalkListEntryResult() == 10:
            assert t000001000_x129()
            return 0
        # Courage
        elif GetTalkListEntryResult() == 11:
            assert t000001000_x130()
            return 0
        # Clarity
        elif GetTalkListEntryResult() == 12:
            assert t000001000_x131()
            return 0
        # Leave
...
def t000001000_x120():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30000, 80100200, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100300)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x121():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30010, 80100201, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100301)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x122():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30020, 80100202, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100302)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x123():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30030, 80100203, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100303)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x124():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30040, 80100204, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100304)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x125():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30050, 80100205, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100305)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x126():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30060, 80100206, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100306)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x127():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30070, 80100207, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100307)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x128():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30080, 80100208, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100308)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x129():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30090, 80100209, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100309)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x130():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30100, 80100210, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100310)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
def t000001000_x131():
    ...
    while True:
        ...
        # Purchase
        if GetTalkListEntryResult() == 1:
            assert t000001000_x150(30110, 80100211, -10)
            return 0
        # View Effect
        elif GetTalkListEntryResult() == 2:
            assert t000001000_x4(80100311)
            return 0
        # Leave
        elif not (CheckSpecificPersonMenuIsOpen(-1, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)):
            return 0
...
# Randomise Time
        ...
        # Force Day
        AddTalkListDataIf(not GetEventFlag(75211), 2, 80101002, -1)
        
        # Force Noon
        AddTalkListDataIf(not GetEventFlag(75212), 3, 80101003, -1)
        
        # Force Night
        AddTalkListDataIf(not GetEventFlag(75213), 4, 80101004, -1)
