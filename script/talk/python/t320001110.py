...
def t320001110_1():
    ...
    t320001110_x27(flag1=3703, flag2=3701, flag3=3702, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode1=1, mode2=1)
    def WhilePaused():
        c5_121(GetEventFlag(3708) == 1 or (GetEventFlag(3709) == 1 and not GetEventFlag(11102719)), 9620)
    Quit()

def t320001110_1000():
    """State 0,2,3"""
    assert t320001110_x0()
    """State 1"""
    c1_120(1000)
    Quit()
...
def t320001110_2000():
    """State 0,2,3"""
    assert t320001110_x1(z5=10, z6=12)
    """State 1"""
    c1_120(2000)
    Quit()
    ...
    if GetEventFlag(3705) == 1 or GetEventFlag(3707) == 1:
        ...
        if not GetEventFlag(1041389412):
            while True:
                """State 9"""
                # actionbutton:6000:"Talk"
                call = t320001110_x21(actionbutton1=6000, flag5=6001, flag9=6000, flag10=6000, flag11=6000,
                ...
                if call.Done():
                    ...
                    assert t320001110_x52(text1=32080000, z7=1041382731, mode3=1)
                    """State 2"""
                    ...
                    assert t320001110_x52(text1=32080300, z7=1041382732, mode3=1)
                    """State 3"""
                    ...
                    assert t320001110_x52(text1=32080500, z7=1041382733, mode3=1)
                    """State 4"""
            ...
            assert (t320001110_x21(actionbutton1=6500, flag5=6001, flag9=6000, flag10=6000, flag11=6000,
                    flag12=6000, flag4=6000))
    else:
        Goto('L1')
    """State 14"""
...
def t320001110_x3():
    ...
    if GetEventFlag(11109255) == 1 and GetEventFlag(1041389412) == 1 and not GetEventFlag(11109258):
        """State 5"""
        assert t320001110_x17()
    else:
        """State 1"""
        if not GetEventFlag(11109256):
            """State 4"""
            assert t320001110_x12()
            """State 2"""
            if GetEventFlag(11109210) == 1:
                """State 6"""
                assert t320001110_x13()
            else:
                pass
        else:
            """State 7"""
            assert t320001110_x14()
    """State 8"""
    return 0

def t320001110_x4():
    """State 0,1"""
    assert t320001110_x7() and (CheckSpecificPersonTalkHasEnded(0) == 1 and not IsMenuOpen(63))
    """State 2"""
    assert t320001110_x8()
    """State 3"""
    return 0
...
def t320001110_x5():
    ...
    if not GetEventFlag(11109275):
        ...
        assert t320001110_x51(text2=32006000, mode4=1)
        """State 2"""
        SetEventFlag(11109275, 1)
    else:
        """State 4"""
        # talk:32006100:"I see. You're here for some spirit tuning?"
        assert t320001110_x51(text2=32006100, mode4=1)
    """State 5"""
    assert t320001110_x9()
    """State 6"""
    return 0
...
def t320001110_x6():
    ...
    if not GetEventFlag(1041389406):
        ...
        assert t320001110_x51(text2=32000100, mode4=1)
        """State 9"""
...
def t320001110_x7():
    ...
    if not GetEventFlag(11109265):
        ...
        assert t320001110_x51(text2=32004000, mode4=1)
        """State 5"""
        if not GetEventFlag(60835):
            """State 4"""
            # gesture:93:Sitting Sideways
        ...
        assert t320001110_x51(text2=32005000, mode4=1)
    """State 9"""
    return 0
...
def t320001110_x8():
    ...
    while True:
        ...
        ClearTalkListData()
        """State 24,28"""
        assert t320001110_x18()
        """State 29"""
        assert t320001110_x19()
        """State 3"""
        ...
        # if GetTalkListEntryResult() == 1:
            ...
            assert t320001110_x51(text2=32005100, mode4=1)
            """State 12"""
            ...
            assert t320001110_x51(text2=32005200, mode4=1)
            """State 15"""
            SetEventFlag(1041389411, 1)
            """State 27"""
            # lot:101900:Spirit Jellyfish Ashes
            assert (t320001110_x24(lot1=101900) and (CheckSpecificPersonTalkHasEnded(0) == 1 and not
                    IsMenuOpen(63)))
        elif GetTalkListEntryResult() == 50:
            """State 30"""
            assert t320001110_x20() and CheckSpecificPersonTalkHasEnded(0) == 1
        else:
            """State 8,31"""
            return 0
...
def t320001110_x9():
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t320001110_x51(text2=32007000, mode4=1)
            """State 10"""
            ...
            assert t320001110_x51(text2=32008000, mode4=1)
            """State 11"""
            ...
            assert t320001110_x51(text2=32008100, mode4=1)
            """State 13"""
            ...
            assert t320001110_x51(text2=32008200, mode4=1)
            """State 16"""
...
def t320001110_x10():
    ...
    if not GetEventFlag(1041389413):
        ...
        assert t320001110_x51(text2=32002000, mode4=1)
        """State 1"""
        SetEventFlag(1041389413, 1)
    else:
        """State 4"""
        # talk:32002100:"I think I'll head to the Roundtable Hold."
        assert t320001110_x51(text2=32002100, mode4=1)
    """State 5"""
    return 0
...
def t320001110_x11():
    ...
    if GetTalkListEntryResult() == 1:
        ...
        assert t320001110_x51(text2=32001300, mode4=1)
    else:
        """State 8"""
        pass
    """State 10"""
...
def t320001110_x12():
    ...
    if not GetEventFlag(11109255):
        ...
        if GetEventFlag(1041389406) == 1:
            ...
            assert t320001110_x51(text2=32003000, mode4=1)
        else:
            """State 3,10"""
            # talk:32003400:"A pleasure to meet you."
            assert t320001110_x51(text2=32003400, mode4=1)
        """State 4"""
        ...
        if GetEventFlag(1041382735) == 1:
            ...
            assert t320001110_x51(text2=32003500, mode4=1)
        else:
            """State 12"""
            # talk:32003600:"A pleasure to see you."
            assert t320001110_x51(text2=32003600, mode4=1)
        """State 8"""
        SetEventFlag(1041382735, 1)
    """State 13"""
    return 0
...
def t320001110_x13():
    ...
    if GetTalkListEntryResult() == 1:
        ...
        assert t320001110_x51(text2=32003200, mode4=1)
    else:
        """State 6"""
        pass
    """State 9"""
...
def t320001110_x14():
    ...
    assert t320001110_x51(text2=32003700, mode4=1)
    """State 2"""
    return 0

def t320001110_x15():
    """State 0,1"""
    assert t320001110_x5()
    """State 2"""
    return 0
...
def t320001110_x16():
    ...
    if GetEventFlag(1041382735) == 1 or not GetEventFlag(1041389408):
        ...
        assert t320001110_x51(text2=32000500, mode4=1)
        """State 2"""
        SetEventFlag(1041389408, 1)
    else:
        """State 4"""
        # talk:32001400:"A pleasure to see you."
        assert t320001110_x51(text2=32001400, mode4=1)
    """State 5"""
    return 0
...
def t320001110_x17():
    ...
    assert t320001110_x51(text2=32003300, mode4=1)
    """State 1"""
    SetEventFlag(11109258, 1)
    """State 3"""
    # lot:101910:Golden Seed
    assert t320001110_x24(lot1=101910)
    """State 4"""
    return 0
...
def t320001110_x21(actionbutton1=_, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000, flag4=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t320001110_x25(val2=10, val3=12):
    """State 0,1"""
...
def t320001110_x27(flag1=3703, flag2=3701, flag3=3702, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode1=1, mode2=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t320001110_x44(flag1=flag1, flag2=flag2, flag3=flag3, val1=val1, val2=val2, val3=val3,
...
def t320001110_x28(val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000, flag4=6000, flag5=6001,
                   flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000, z4=1000000, mode1=1,
                   mode2=1):
    """State 0"""
    while True:
        """State 2"""
        call = t320001110_x31(actionbutton1=actionbutton1, flag4=flag4, flag5=flag5, z2=z2, z3=z3, z4=z4)
        def WhilePaused():
        ...
        if call.Done():
            ...
            Label('L0')
            c1_138(1000000)
            call = t320001110_x35(val1=val1, z1=z1)
            def WhilePaused():
            ...
            """State 6"""
            assert t320001110_x48() and CheckSpecificPersonTalkHasEnded(0) == 1
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t320001110_x33(val2=val2, val3=val3)
    """Unused"""
    """State 7"""
    return 0

def t320001110_x29(val2=10, val3=12):
    """State 0,1"""
    call = t320001110_x39(val2=val2, val3=val3)
    assert IsPlayerDead() == 1
    """State 2"""
    t320001110_x25(val2=val2, val3=val3)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t320001110_x30(flag1=3703, val2=10, val3=12):
    """State 0,8"""
    assert t320001110_x56()
    """State 1"""
...
def t320001110_x31(actionbutton1=6000, flag4=6000, flag5=6001, z2=1000000, z3=1000000, z4=1000000):
    """State 0,1"""
    call = t320001110_x32(z8=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
        assert (t320001110_x21(actionbutton1=actionbutton1, flag5=flag5, flag9=6000, flag10=6000, flag11=6000,
...
def t320001110_x32(z8=_, val6=_):
    """State 0,1"""
    if f203(z8) == 1:
        """State 2"""
...
def t320001110_x33(val2=10, val3=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t320001110_x22()
...
def t320001110_x34():
    """State 0,1"""
    assert t320001110_x32(z8=1101, val6=1101)
    """State 2"""
    return 0

def t320001110_x35(val1=5, z1=1):
    """State 0,2"""
    assert t320001110_x45()
    """State 1"""
    call = t320001110_x36()
    if call.Done():
        pass
        ...
        """State 3"""
        assert t320001110_x47()
    """State 4"""
    return 0

def t320001110_x36():
    """State 0,1"""
    assert t320001110_x32(z8=1000, val6=1000)
    """State 2"""
    return 0

def t320001110_x37(val5=12):
    """State 0,1"""
    call = t320001110_x38()
    if call.Done():
        pass
        ...
        """State 2"""
        assert t320001110_x48()
    """State 3"""
    return 0

def t320001110_x38():
    """State 0,1"""
    assert t320001110_x32(z8=1100, val6=1100)
    """State 2"""
    return 0

def t320001110_x39(val2=10, val3=12):
    """State 0,5"""
    assert t320001110_x56()
    """State 2"""
...
def t320001110_x40():
    """State 0,2"""
    call = t320001110_x32(z8=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t320001110_x41():
    """State 0,1"""
    assert t320001110_x32(z8=1001, val6=1001)
    """State 2"""
    return 0

def t320001110_x42():
    """State 0,1"""
    assert t320001110_x32(z8=1103, val6=1103)
    """State 2"""
    return 0
...
def t320001110_x44(flag1=3703, flag2=3701, flag3=3702, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode1=1, mode2=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t320001110_x28(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, actionbutton1=actionbutton1,
                              flag4=flag4, flag5=flag5, flag6=flag6, flag7=flag7, flag8=flag8, z1=z1,
                              z2=z2, z3=z3, z4=z4, mode1=mode1, mode2=mode2)
        if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
            """State 3"""
            Label('L0')
            call = t320001110_x30(flag1=flag1, val2=val2, val3=val3)
            ...
            """State 2"""
            call = t320001110_x29(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
                Goto('L0')
            ...
            pass
        """State 4"""
        assert t320001110_x55() and (not GetEventFlag(9000) and not IsPlayerDead())
    """Unused"""
    """State 5"""
    return 0
...
def t320001110_x45():
    """State 0,1"""
    assert t320001110_x46()
    """State 2"""
    return 0

def t320001110_x46():
    """State 0,1"""
    assert t320001110_x32(z8=1104, val6=1104)
    """State 2"""
    return 0

def t320001110_x47():
    """State 0,1"""
    call = t320001110_x32(z8=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
        assert t320001110_x26()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t320001110_x48():
    """State 0,1"""
    call = t320001110_x32(z8=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t320001110_x26()
    elif call.Done():
...
def t320001110_x49():
    """State 0,1"""
    call = t320001110_x32(z8=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t320001110_x26()
    elif call.Done():
...
def t320001110_x50():
    """State 0,1"""
    call = t320001110_x32(z8=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t320001110_x26()
    elif call.Done():
...
def t320001110_x51(text2=_, mode4=1):
    """State 0,4"""
    assert t320001110_x23() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t320001110_x52(text1=_, z7=_, mode3=1):
    """State 0,5"""
    assert t320001110_x53() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 2"""
    SetEventFlag(z7, 1)
    """State 1"""
...
def t320001110_x54():
    """State 0,1"""
    assert t320001110_x32(z8=1002, val6=1002)
    """State 2"""
    return 0
