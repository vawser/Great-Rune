...
def t800001100_1():
    ...
    t800001100_x7(flag1=4703, flag2=4701, flag3=4702, val2=5, val3=10, val4=12, val5=10, val6=12, actionbutton1=6000,
...
def t800001100_2000():
    """State 0,2,3"""
    assert t800001100_x42(val1=10, z1=12)
    """State 1"""
    c1_120(2000)
    Quit()

def t800001100_x0(action1=_):
    """State 0,1"""
...
def t800001100_x1(actionbutton1=6000, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                  flag4=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t800001100_x5(val3=10, val4=12):
    """State 0,1"""
...
def t800001100_x7(flag1=4703, flag2=4701, flag3=4702, val2=5, val3=10, val4=12, val5=10, val6=12, actionbutton1=6000,
                  flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z2=1, z3=1000000, z4=1000000,
                  z5=1000000, mode1=1, mode2=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t800001100_x24(flag1=flag1, flag2=flag2, flag3=flag3, val2=val2, val3=val3, val4=val4,
...
def t800001100_x8(val2=5, val3=10, val4=12, val5=10, val6=12, actionbutton1=6000, flag4=6000, flag5=6001,
                  flag6=6000, flag7=6000, flag8=6000, z2=1, z3=1000000, z4=1000000, z5=1000000, mode1=1,
                  mode2=1):
    """State 0"""
    while True:
        """State 2"""
        call = t800001100_x11(actionbutton1=actionbutton1, flag4=flag4, flag5=flag5, z3=z3, z4=z4, z5=z5)
        def WhilePaused():
        ...
        if call.Done():
            ...
            Label('L0')
            c1_138(1000000)
            call = t800001100_x15(val2=val2, z2=z2)
            def WhilePaused():
            ...
            """State 6"""
            assert t800001100_x28() and CheckSpecificPersonTalkHasEnded(0) == 1
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t800001100_x13(val3=val3, val4=val4)
    """Unused"""
    """State 7"""
    return 0

def t800001100_x9(val3=10, val4=12):
    """State 0,1"""
    call = t800001100_x19(val3=val3, val4=val4)
    assert IsPlayerDead() == 1
    """State 2"""
    t800001100_x5(val3=val3, val4=val4)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t800001100_x10(flag1=4703, val3=10, val4=12):
    """State 0,8"""
    assert t800001100_x36()
    """State 1"""
...
def t800001100_x11(actionbutton1=6000, flag4=6000, flag5=6001, z3=1000000, z4=1000000, z5=1000000):
    """State 0,1"""
    call = t800001100_x12(z6=2000, val7=2000)
    if call.Get() == 1:
        """State 2"""
        assert (t800001100_x1(actionbutton1=actionbutton1, flag5=flag5, flag9=6000, flag10=6000, flag11=6000,
...
def t800001100_x12(z6=_, val7=_):
    """State 0,1"""
    if f203(z6) == 1:
        """State 2"""
...
def t800001100_x13(val3=10, val4=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t800001100_x2()
...
def t800001100_x14():
    """State 0,1"""
    assert t800001100_x12(z6=1101, val7=1101)
    """State 2"""
    return 0

def t800001100_x15(val2=5, z2=1):
    """State 0,2"""
    assert t800001100_x25()
    """State 1"""
    call = t800001100_x16()
    if call.Done():
        pass
        ...
        """State 3"""
        assert t800001100_x27()
    """State 4"""
    return 0

def t800001100_x16():
    """State 0,1"""
    assert t800001100_x12(z6=1000, val7=1000)
    """State 2"""
    return 0

def t800001100_x17(val6=12):
    """State 0,1"""
    call = t800001100_x18()
    if call.Done():
        pass
        ...
        """State 2"""
        assert t800001100_x28()
    """State 3"""
    return 0

def t800001100_x18():
    """State 0,1"""
    assert t800001100_x12(z6=1100, val7=1100)
    """State 2"""
    return 0

def t800001100_x19(val3=10, val4=12):
    """State 0,5"""
    assert t800001100_x36()
    """State 2"""
...
def t800001100_x20():
    """State 0,2"""
    call = t800001100_x12(z6=1102, val7=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t800001100_x21():
    """State 0,1"""
    assert t800001100_x12(z6=1001, val7=1001)
    """State 2"""
    return 0

def t800001100_x22():
    """State 0,1"""
    assert t800001100_x12(z6=1103, val7=1103)
    """State 2"""
    return 0
...
def t800001100_x24(flag1=4703, flag2=4701, flag3=4702, val2=5, val3=10, val4=12, val5=10, val6=12, actionbutton1=6000,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z2=1, z3=1000000, z4=1000000,
                   z5=1000000, mode1=1, mode2=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t800001100_x8(val2=val2, val3=val3, val4=val4, val5=val5, val6=val6, actionbutton1=actionbutton1,
                             flag4=flag4, flag5=flag5, flag6=flag6, flag7=flag7, flag8=flag8, z2=z2,
                             z3=z3, z4=z4, z5=z5, mode1=mode1, mode2=mode2)
        if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
            """State 3"""
            Label('L0')
            call = t800001100_x10(flag1=flag1, val3=val3, val4=val4)
            ...
            """State 2"""
            call = t800001100_x9(val3=val3, val4=val4)
            if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
                Goto('L0')
            ...
            pass
        """State 4"""
        assert t800001100_x35() and not GetEventFlag(9000)
    """Unused"""
    """State 5"""
    return 0
...
def t800001100_x25():
    """State 0,1"""
    assert t800001100_x26()
    """State 2"""
    return 0

def t800001100_x26():
    """State 0,1"""
    assert t800001100_x12(z6=1104, val7=1104)
    """State 2"""
    return 0

def t800001100_x27():
    """State 0,1"""
    call = t800001100_x12(z6=1201, val7=1201)
    if call.Get() == 1:
        """State 2"""
        assert t800001100_x6()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t800001100_x28():
    """State 0,1"""
    call = t800001100_x12(z6=1300, val7=1300)
    if call.Get() == 1:
        """State 2"""
        assert t800001100_x6()
    elif call.Done():
...
def t800001100_x29():
    """State 0,1"""
    call = t800001100_x12(z6=1301, val7=1301)
    if call.Get() == 1:
        """State 2"""
        assert t800001100_x6()
    elif call.Done():
...
def t800001100_x30():
    """State 0,1"""
    call = t800001100_x12(z6=1302, val7=1302)
    if call.Get() == 1:
        """State 2"""
        assert t800001100_x6()
    elif call.Done():
...
def t800001100_x31(text2=_, mode4=1):
    """State 0,4"""
    assert t800001100_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t800001100_x32(text1=_, mode3=1):
    """State 0,4"""
    assert t800001100_x33() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t800001100_x34():
    """State 0,1"""
    assert t800001100_x12(z6=1002, val7=1002)
    """State 2"""
    return 0
...
def t800001100_x37():
    ...
    """Unused"""
    """State 4"""
    assert t800001100_x44()
    Goto('L0')
    """State 5"""
    assert t800001100_x45()
    Goto('L0')
    """State 6"""
    assert t800001100_x46()
    Goto('L0')
    """State 7"""
    assert t800001100_x47()
    Goto('L0')

def t800001100_x38():
    """State 0,2,6"""
    # talk:80080300:"Is that all you were, mate?"
    assert t800001100_x32(text1=80080300, mode3=1)
    """State 7"""
    Label('L0')
    return 0
    """Unused"""
    ...
    assert t800001100_x32(text1=80081300, mode3=1)
    Goto('L0')

def t800001100_x39():
    """State 0,1,3,7"""
    assert t800001100_x78()
    """State 8"""
    Label('L0')
    return 0
    """Unused"""
...
def t800001100_x40():
    ...
    if not GetEventFlag(1042369303):
        ...
        assert t800001100_x32(text1=80080200, mode3=1)
    ...
    assert t800001100_x32(text1=80081200, mode3=1)
    Goto('L0')
    """State 16"""
    return 0
...
def t800001100_x41():
    ...
    assert t800001100_x32(text1=80080400, mode3=1)
    """State 7"""
    Label('L0')
    return 0
    """Unused"""
    ...
    assert t800001100_x32(text1=80081400, mode3=1)
    Goto('L0')

def t800001100_x42(val1=10, z1=12):
    """State 0"""
    while True:
        """State 4"""
        Label('L0')
        if GetEventFlag(4705) == 1:
            ...
            """State 3,7"""
            # actionbutton:6000:"Talk"
            call = t800001100_x1(actionbutton1=6000, flag5=6001, flag9=6000, flag10=6000, flag11=6000,
    ...
    """Unused"""
    """State 1,8"""
    call = t800001100_x76(val1=val1, z1=z1)
    if call.Done():
        Goto('L1')
...
def t800001100_x43():
    ...
    assert t800001100_x50()
    """State 2"""
    return 0

def t800001100_x44():
    """State 0,1"""
    assert t800001100_x58()
    """State 2"""
    return 0

def t800001100_x45():
    """State 0,1"""
    assert t800001100_x65()
    """State 2"""
    return 0
...
def t800001100_x46():
    ...
    if not GetEventFlag(35000500):
        """State 2"""
        assert t800001100_x74()
    else:
        """State 3"""
        assert t800001100_x75()
    """State 4"""
    return 0
...
def t800001100_x47():
    ...
    if not GetEventFlag(35000500):
        ...
        assert t800001100_x31(text2=80007100, mode4=1)
    else:
        """State 5,7"""
        # talk:80001500:"The howl of a wolf, in the Mistwood..."
        def WhilePaused():
            RequestAnimation(20041, -1)
        assert t800001100_x31(text2=80001500, mode4=1)
    """State 1"""
...
def t800001100_x49():
    ...
    if not GetEventFlag(1042369308):
        ...
        assert t800001100_x31(text2=80000100, mode4=1)
        """State 10"""
        assert t800001100_x48()
        """State 5"""
        ...
        """State 3,8"""
        assert t800001100_x53()
    else:
        """State 4,9"""
        assert t800001100_x52()
    """State 11"""
    return 0

def t800001100_x50():
    """State 0,1"""
    assert t800001100_x49()
    """State 2"""
    assert t800001100_x51()
    """State 3"""
    return 0
...
def t800001100_x51():
    ...
    while True:
        ...
        ClearTalkListData()
        """State 27"""
        assert t800001100_x56()
        """State 29"""
        assert t800001100_x80()
        """State 3"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 8,25"""
            assert t800001100_x55()
        elif GetTalkListEntryResult() == 4:
            """State 23,30"""
            assert t800001100_x81()
        elif GetTalkListEntryResult() == 5:
            """State 21,28"""
            # talk:80000800:"You know, if you can spare the runes,"
            assert t800001100_x31(text2=80000800, mode4=1)
            """State 22"""
            SetEventFlag(1042369314, 1)
        # Browse Inventory
        elif GetTalkListEntryResult() == 10:
            assert t800001100_x100()
        # Browse Cut Content
        elif GetTalkListEntryResult() == 11:
            assert t800001100_x200()
        # Get Runes
        elif GetTalkListEntryResult() == 12:
            GiveSpEffectToPlayer(9006000)
        else:
            """State 9,26"""
            assert t800001100_x57()
            """State 31"""
            return 0
...
def t800001100_x52():
    ...
    if not GetEventFlag(1042369311) and not GetEventFlag(4707):
        ...
        assert t800001100_x31(text2=80000300, mode4=1)
    else:
        """State 3,5"""
        # talk:80000400:"Ah, it's you again."
        assert t800001100_x31(text2=80000400, mode4=1)
    """State 6"""
    assert t800001100_x48()
    """State 7"""
    return 0
...
def t800001100_x53():
    ...
    assert t800001100_x31(text2=80000200, mode4=1)
    """State 2"""
    return 0
...
def t800001100_x55():
    ...
    if GetEventFlag(1042369319) == 1:
        ...
        assert t800001100_x31(text2=80000700, mode4=1)
        """State 5"""
        ...
        assert t800001100_x31(text2=80001000, mode4=1)
        """State 7"""
        SetEventFlag(1042369315, 1)
    else:
        """State 4,11"""
        # talk:80001200:"Perhaps you don't need to hear this, but..."
        assert t800001100_x31(text2=80001200, mode4=1)
        """State 8"""
...
def t800001100_x57():
    ...
    if GetEventFlag(1042369306) == 1 and GetEventFlag(1042369307) == 1 and GetEventFlag(1042369314) == 1:
        ...
        assert t800001100_x31(text2=80000900, mode4=1)
    else:
        """State 3,5"""
        assert t800001100_x63()
    """State 6"""
    return 0

def t800001100_x58():
    """State 0,1"""
    assert t800001100_x59()
    """State 2"""
    assert t800001100_x60()
    """State 3"""
    return 0
...
def t800001100_x59():
    ...
    if not GetEventFlag(1037429255) and not GetEventFlag(1042369311):
        ...
        assert t800001100_x31(text2=80003100, mode4=1)
        """State 11"""
        Label('L0')
        assert t800001100_x48()
        """State 6"""
        ...
        assert t800001100_x31(text2=80003000, mode4=1)
        Goto('L0')
    elif GetEventFlag(1042362712) == 1:
        """State 4,9"""
        assert t800001100_x53()
...
def t800001100_x60():
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 8,15"""
            assert t800001100_x61()
        elif GetTalkListEntryResult() == 4:
            """State 9,16"""
            assert t800001100_x62()
        else:
            """State 10,17"""
            assert t800001100_x71()
            """State 19"""
            return 0
...
def t800001100_x62():
    """State 0,8"""
    call = t800001100_x0(action1=28001001)
    if call.Get() == 0:
        """State 2,1"""
        # goods:1200:Gold-Pickled Fowl Foot
        ...
        assert t800001100_x31(text2=80003300, mode4=1)
    elif call.Done():
        """State 3"""
        pass
    """State 10"""
...
def t800001100_x63():
    ...
    if DidYouDoSomethingInTheMenu(0) == 1:
        ...
        assert t800001100_x31(text2=80000600, mode4=1)
    else:
        """State 3,5"""
        # talk:80000500:"Good-bye for now."
        assert t800001100_x31(text2=80000500, mode4=1)
    """State 6"""
    return 0
...
def t800001100_x65():
    """State 0,1"""
    assert t800001100_x66()
    """State 2"""
    assert t800001100_x67()
    """State 3"""
    return 0
...
def t800001100_x66():
    ...
    if not GetEventFlag(11009305):
        ...
        assert t800001100_x31(text2=80005000, mode4=1)
        """State 7"""
        assert t800001100_x48()
        """State 5"""
...
def t800001100_x67():
    ...
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            ...
            """State 8,16"""
            assert t800001100_x70()
        elif GetTalkListEntryResult() == 4:
            """State 9,15"""
            assert t800001100_x68()
        else:
            """State 10,17"""
            assert t800001100_x72()
            """State 19"""
            return 0

def t800001100_x68():
    """State 0,13"""
    call = t800001100_x0(action1=28001002)
    if call.Get() == 0:
        """State 2,1"""
        # goods:1210:Exalted Flesh
        ...
        assert t800001100_x31(text2=80005200, mode4=1)
        """State 7"""
        ClearTalkListData()
        """State 8"""
...
def t800001100_x69():
    ...
    assert t800001100_x31(text2=80005300, mode4=1)
    """State 1"""
    SetEventFlag(11009307, 1)
    """State 3"""
    # lot:100420:Glowstone
    assert t800001100_x4(lot1=100420)
    """State 4"""
    # talk:80005310:"I hope you can join me at the Great Caravan, in fact."
    assert t800001100_x31(text2=80005310, mode4=1)
    """State 5"""
    return 0
...
def t800001100_x70():
    ...
    if GetEventFlag(11009311) == 1:
        ...
        assert t800001100_x31(text2=80005100, mode4=1)
        """State 4"""
...
def t800001100_x75():
    ...
    if not GetEventFlag(35009254):
        ...
        assert t800001100_x31(text2=80005800, mode4=1)
        """State 4"""
        SetEventFlag(35009254, 1)
    else:
        """State 3,6"""
        # talk:80005900:"Oh, that's it... That's what I need..."
        assert t800001100_x31(text2=80005900, mode4=1)
    """State 7"""
    return 0

def t800001100_x76(val1=10, z1=12):
    """State 0"""
    while True:
        """State 3"""
        ...
        if GetEventFlag(4703) == 1:
            ...
            assert t800001100_x32(text1=80007000, mode3=1) and GetCurrentStateElapsedTime() > 35
    """State 2"""
    Quit()
    """Unused"""
    """State 5"""
...
def t800001100_x77():
    ...
    while True:
        """State 3"""
        # actionbutton:6000:"Talk"
        call = t800001100_x1(actionbutton1=6000, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                             flag4=6000)
        if call.Done():
            break
            ...
            assert t800001100_x32(text1=80080100, mode3=1)
    """State 5"""
    return 0
...
def t800001100_x78():
    ...
    if not GetEventFlag(1042362711) and not GetEventFlag(1042362716):
        ...
        """State 10"""
        # talk:80080000:"Urgh!"
        assert t800001100_x32(text1=80080000, mode3=1)
...
def t800001100_x79():
    ...
    if not GetEventFlag(1042362711):
        ...
        assert t800001100_x32(text1=80081000, mode3=1)
    elif not GetEventFlag(1042362716):
        """State 3,6"""
        SetEventFlag(1042362716, 1)
        """State 8"""
        # talk:80081100:"So you're just like the others?"
        assert t800001100_x32(text1=80081100, mode3=1)
    else:
        """State 4"""
        pass
    """State 9"""
...
def t800001100_x81():
    ...
    if GetEventFlag(1042369320) == 1:
        ...
        assert t800001100_x31(text2=80001700, mode4=1)
        """State 5"""
...
def t800001100_x100():
    ...
    while True:
        ...
        # Items
            ...
            assert t800001100_x101()
        # Gestures
        elif GetTalkListEntryResult() == 11:
            assert t800001100_x110()
        else:
            return 0
