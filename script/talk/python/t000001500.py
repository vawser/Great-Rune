...
def t000001500_x0(actionbutton1=6570, flag2=6001, flag3=6000, flag4=6000, flag5=6000, flag6=6000, flag7=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t000001500_x2(text1=_, flag1=0, mode1=1):
    """State 0,4"""
    assert t000001500_x1() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
